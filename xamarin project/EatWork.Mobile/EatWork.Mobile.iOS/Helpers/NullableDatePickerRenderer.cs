...
[assembly: ExportRenderer(typeof(EatWork.Mobile.Utils.NullableDatePicker), typeof(EatWork.Mobile.iOS.Helpers.NullableDatePickerRenderer))]
...
namespace EatWork.Mobile.iOS.Helpers
{
    public class NullableDatePickerRenderer : DatePickerRenderer
    {
        ...
        private void TryShowEmptyState()
        {
            ...
            if (el != null)
            {
                if (el.NullableDate == null || el.NullableDate.Value <= Constants.NullDate)
                {
