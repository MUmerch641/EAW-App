...
{
    public class MyAttendanceViewModel : ListViewModel
    {
        ...
        private MyAttendanceListHolder holder_;

        public MyAttendanceListHolder Holder
        {
            get { return holder_; }
            set { holder_ = value; RaisePropertyChanged(() => Holder); }
        }

        private MyAttendanceListModel TappedItem;

        private readonly IMyAttendanceDataService service_;

        public MyAttendanceViewModel(IMyAttendanceDataService service)
        {
            service_ = service;
        }
        ...
        {
            Holder = new MyAttendanceListHolder();
        ...
        private async void LoadListItems()
        {
            if (!IsBusy)
            {
                try
                {
                    ...
                    Holder.MyAttendanceList = new ObservableCollection<MyAttendanceListModel>();
        ...
        {
            var tappedItemData = obj as MyAttendanceListModel;
        ...
        private void UpdateRequest(MyAttendanceListModel item)
        {
        ...
        private async Task RetrieveList()
        {
            ...
            Holder.MyAttendanceList = await service_.GetListAsync(Holder.MyAttendanceList, obj);
