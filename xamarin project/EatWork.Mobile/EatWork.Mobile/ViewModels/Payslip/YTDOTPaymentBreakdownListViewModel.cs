...
{
    public class YTDOTPaymentBreakdownListViewModel : ListViewModel
    {
        ...
        public YTDOTPaymentBreakdownListViewModel(IPayslipDataService service)
        {
            service_ = service;
        }
            ...
            try
            {
                if (obj != null)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        {
                            await Task.Delay(500);
                            await NavigationService.PushPageAsync(new YTDOTPaymentBreakdownDetailPage(item.PaysheetHeaderId, item.ProfileId));
                        }
                    }
                }
            }
