...
namespace EatWork.Mobile.Utils
{
    ...
    public class CustomShadowFrame : Frame
    {
        ...
        //public static readonly BindableProperty TopBorderColorProperty =
        //    BindableProperty.Create("TopBorderColor", typeof(Color), typeof(CustomShadowFrame), default(Color), BindingMode.Default);

        //public static readonly BindableProperty BottomBorderColorProperty =
        //    BindableProperty.Create("BottomBorderColor", typeof(Color), typeof(CustomShadowFrame), default(Color), BindingMode.Default);
