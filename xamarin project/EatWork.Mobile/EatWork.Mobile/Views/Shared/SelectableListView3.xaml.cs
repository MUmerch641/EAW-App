...
namespace EatWork.Mobile.Views.Shared
{
    ...
    public partial class SelectableListView3 : StackLayout
    {
        ...
        public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create(
                                                                        ...
                                                                        declaringType: typeof(SelectableListView3),
        ...
        {
            var control = (SelectableListView3)bindable;
        ...
        {
            if (bindable is SelectableListView3 control && newValue is ICommand command)
            {
                control.Command = command;
            }
        }

        public SelectableListView3()
        {
            InitializeComponent();
        }
    }
