...
namespace EatWork.Mobile.Views.Requests
{
    ...
    public partial class ChangeWorkSchedulePage : ContentPage
    {
        public ChangeWorkSchedulePage(MyRequestListModel item = null)
        {
            InitializeComponent();
        ...
        {
            MessagingCenter.Send<ChangeWorkSchedulePage>(this, "onback");
            return true;
        }
    }
}